...
| 版本 | 功能模块 | 状态 | 说明 |
| :--- | :--- | :--- | :--- |
| **V1.0** | **核心归档器** | ✅ 已完成 | CLI 工具，本地 Markdown 转换与存储 |
| **V1.1** | **云端同步** | ✅ 已完成 | 对接飞书 API，实现图片上传与文档导入 |
| **V1.2** | **Web 界面化** | ✅ 已完成 | 现代化 Web UI，任务历史管理 |
| **V1.3** | **SaaS 服务化** | 🚧 进行中 | 支持飞书扫码登录 (OAuth)，实现多用户隔离与个人空间存储 |
